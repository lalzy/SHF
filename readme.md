...
it was depricated in favor of [yggdrasil](https://github.com/lalzy/yggdrasil-old) and exist as personal journey/history only. Much of the core concepts of what started SDF retains in Yggdrasil, but was rewritten to be clearer (code-wise), and feel more like an engine, instead of a series of SDL-helpers.

One of the issues of SHF, is how tied it is to SDL, which made changing renderer(and 'future' ambition) not realistic, and so Yggdrasil was born, to replace this.
